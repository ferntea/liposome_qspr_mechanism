...
def create_umap_comparison():
    ...
    try:
        ...
        ax1.set_title('50 Original Fragments', fontweight='bold', fontsize=16)
        ax1.set_xlabel('UMAP1', fontweight='bold', fontsize=14)
        ax1.set_ylabel('UMAP2', fontweight='bold', fontsize=14)
        ax1.grid(True, alpha=0.3)
        
        # Right panel: 10 mechanistic fragments - legend at upper right  
        scatter2 = ax2.scatter(embedding_10[:, 0], embedding_10[:, 1], 
                              c=colors, alpha=0.6, s=40, edgecolors='none')
        ax2.set_title('10 Mechanistic Fragments', fontweight='bold', fontsize=16)
        ax2.set_xlabel('UMAP1', fontweight='bold', fontsize=14)
        ax2.set_ylabel('UMAP2', fontweight='bold', fontsize=14)
